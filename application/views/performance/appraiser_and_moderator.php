	...
	<div class="row ">
	 ...
	 if( isset($appraiser_and_moderator_list) && !empty($appraiser_and_moderator_list) ) {
        ...
        foreach ($appraiser_and_moderator_list as $r) {
            ...
            echo "<tr>";
            echo "<td  title='$r->moderator_nic_no' >" . $r->moderator_officer_name . "</td>";
            echo "<td>" . $r->moderator_post_name . "</td>";
            echo "<td title='$r->appraiser_nic_no' >" . $r->appraiser_officer_name . "</td>";
            echo "<td>" . $r->appraiser_post_name . "</td>";
            echo "<td>" . $r->personal_file_nic_no . "</td>";
            echo "<td>" . $r->personal_file_officer_name . "</td>";
            echo "<td>" . $r->personal_file_post_name . "</td>";
            
            echo "<td><a href = '".base_url()."index.php/dashboard/appraiser_and_moderator/delete/".$r->id."/".$r->personal_file."' title='මකන්න'>
